...
This repo normally builds with multiple target frameworks (net8.0–net10.0) and the generator targets `netstandard2.0`. The solution file is `LightObjects.sln`. Build and test scripts use the `dotnet` CLI targeting the .NET 10 runtime.
